...
{
  if ( axis_idx == X_AXIS ) { return((1<<ARML_STEP_BIT)); }
  if ( axis_idx == Y_AXIS ) { return((1<<ARMR_STEP_BIT)); }
  return((1<<BASE_STEP_BIT));
}
...
{
  if ( axis_idx == X_AXIS ) { return((1<<ARML_DIRECTION_BIT)); }
  if ( axis_idx == Y_AXIS ) { return((1<<ARMR_DIRECTION_BIT)); }
  return((1<<BASE_DIRECTION_BIT));
}
